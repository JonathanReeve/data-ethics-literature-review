...
"""
We have a turtle file which describes courses and texts information.
We want to usesemantic scholar API to resolve texts,
and use the data retrieved from that API to augment our own bibliographic data.
"""
...
#my semantic scholar function. Based on given DOIs, it returns title, author
#and abstract and citation URL
