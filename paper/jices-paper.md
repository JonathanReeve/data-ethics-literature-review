...
**Design/methodology/approach**: We utilize data science methods to foster insights about the field of data ethics education and literature. We present a semantic, linked open data graph in the Resource Description Framework (RDF), along with proof-of-concept analyses and a website for its exploration. The graph is language-agnostic, and includes syllabi and resources in other languages. Its framework is open-source, providing the seed for future contributions of code, syllabi, and other resources from the data ethics community. 

**Research limitations/implications**: The syllabi we have collected are self-selected and represents only a subset of the field. Furthermore, our method exclusively represents a course’s assigned literature rather than a holistic view of what is taught and the constructivist dynamics in any given classroom. We do not present a finished product, but the beginnings of a new method for curriculum research and development.
