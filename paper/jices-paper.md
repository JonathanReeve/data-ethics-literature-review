...
Our initial motivations were to collect data on the state of data ethics, in order to answer broad questions, such as: 
...
We are also building a [mechanism for users to submit their own data ethics syllabi to our database](https://data-ethics.tech/submit); this way, our database will always stay up to date. This framework can be adapted by anyone interested in mapping an academic discipline, given a list of courses and their syllabus URLs.
